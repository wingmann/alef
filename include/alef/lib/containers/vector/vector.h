...
#ifndef ALEF_CORE_CONTAINERS_VECTOR_VECTOR_H
#define ALEF_CORE_CONTAINERS_VECTOR_VECTOR_H
...
public:
    ...
    using size_type              = alf::usize;
    using init_list_type         = std::initializer_list<Type>;
    using iterator               = alf::iterators::random_access_iterator<Type>;
    using const_iterator         = alf::iterators::random_access_iterator<const Type>;
...
#endif // ALEF_CORE_CONTAINERS_VECTOR_VECTOR_H
